/*
  ...
  - You are about to drop the column `gpuInstanceId` on the `Training` table. All the data in the column will be lost.
...
INSERT INTO "new_Training" ("baseModel", "config", "createdAt", "id", "name", "ownerId", "status", "triggerWord", "updatedAt") SELECT "baseModel", "config", "createdAt", "id", "name", "ownerId", "status", "triggerWord", "updatedAt" FROM "Training";
DROP TABLE "Training";
