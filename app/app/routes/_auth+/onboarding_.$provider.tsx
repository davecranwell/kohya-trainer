...
import { authenticator, sessionKey, signupWithConnection, requireAnonymous } from '#app/utils/auth.server.ts';
...
export async function action({ request, params }: ActionFunctionArgs) {
    ...
    return redirectWithToast(safeRedirect(redirectTo), { title: 'Welcome', description: 'Thanks for signing up!' }, { headers });
}
