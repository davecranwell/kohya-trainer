        ...
        <div className="flex flex-col gap-12">
            <div className="flex justify-center">
                <div className="relative h-52 w-52">
                    <img alt={data.user.username} className="h-full w-full rounded-full object-cover" />
            ...
            <div className="col-span-6 my-6 h-1 border-b-[1.5px]" />
            ...
            {otherSessionsCount ? (
                <fetcher.Form method="POST">
                    <StatusButton
                        ...
                        <Icon name="avatar">{dc.doubleCheck ? `Are you sure?` : `Sign out of ${otherSessionsCount} other sessions`}</Icon>
                    </StatusButton>
                </fetcher.Form>
            ) : (
